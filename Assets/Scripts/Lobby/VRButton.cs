...
public class VRButton : MonoBehaviour
{
    ...
    [SerializeField] private StudioEventEmitter buttonUpEmitter;
    [SerializeField] private StudioEventEmitter buttonDownEmitter;
    ...
    private void Start()
    {
        ...
        buttonUpEmitter = GetComponent<StudioEventEmitter>();
    }

...
namespace RNGNeeds.Editor
{
    ...
    internal class ProbabilityListDrawer : LabDrawerBase
    {
        ...
        protected override void BaseDraw(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                m_DepletableStripeButtonRect.Set(m_NormalizeBarsButtonRect.xMax + 6f, optionsYPosition, 20f, 20f);
                m_SeparatorCRect.Set(m_DepletableStripeButtonRect.xMax, optionsYPosition, 14f, 20f);
            } else m_SeparatorCRect.Set(m_NormalizeBarsButtonRect.xMax, optionsYPosition, 14f, 20f);
            ...
            EditorGUI.BeginProperty(position, label, property);
            {
                ...
                switch (cpd.DrawerSettings.DrawerOptionSection)
                {
                    ...
                    case DrawerOptionSection.Theme: // Draw Theme options
                        ...
                        m_StripeHeightOptionDButtonRect.Set(cpd.SubOptionsRect.xMax - 56f , m_StripeHeightOptionAButtonRect.y, 50f, 18f);
                        m_StripeHeightOptionCButtonRect.Set(m_StripeHeightOptionDButtonRect.x - 76f, m_StripeHeightOptionAButtonRect.y, 70f, 18f);
                        m_StripeHeightOptionBButtonRect.Set(m_StripeHeightOptionCButtonRect.x - 66f, m_StripeHeightOptionAButtonRect.y, 60f, 18f);
                        m_StripeHeightOptionAButtonRect.Set(m_StripeHeightOptionBButtonRect.x - 86f, subOptionsYPosition + 1f, 80f, 18f);
                    ...
                    case DrawerOptionSection.Picks:
                        ...
                        if(GUI.Button(new Rect(m_PickCountMinRect.x, subOptionsSecondRowYPosition, m_PickCountCurveRect.xMax - m_PickCountMinRect.x, 20f), PLDrawerContents.MaintainPickCountButton, cpd.p_MaintainPickCountIfDisabled.boolValue ? PLDrawerTheme.OptionLinkButtonOn : PLDrawerTheme.OptionLinkButtonOff))
                        {
                        ...
                        if(showAdvancedOptions)
                        {
                            ...
                            if (cpd.p_DepletableList.boolValue)
                            {
                                ...
                                m_DepletableListActionButtonRect.Set(m_RollSectionSeparatorRect.xMax, subOptionsSecondRowYPosition, actionRectWidth, 20f);
